<section class="bg-secondary">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="{{ asset('web_assets/assets/img/gallery/footer-logo.png') }}" height="51" alt="" /></a>
